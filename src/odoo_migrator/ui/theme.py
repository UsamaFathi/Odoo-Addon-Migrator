...
QLabel#fieldLabel {{ color: {COLORS['accent']}; font-size: 11px; font-weight: 700; letter-spacing: 1px; }}
...
QLineEdit:disabled, QComboBox:disabled {{ background-color: #F2F4F7; color: {COLORS['secondary']}; border-color: #D0D5DD; }}
